  ...
  return (
    <div className="clean-insights" style={{ height: '100%', width: '100%', background: 'var(--bg-card, #fff)', color: 'var(--text-primary, #0F172A)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="p-4 space-y-4" style={{ padding: '16px', flex: 1, overflowY: 'auto' }}>
        ...
        {/* AI Advisory Section - Enhanced Visibility */}
        <div style={{ 
          marginBottom: '20px', 
          ...
          <div style={{ position: 'absolute', top: '-20px', right: '-20px', width: '100px', height: '100px', background: 'rgba(250, 204, 21, 0.05)', filter: 'blur(40px)', borderRadius: '50%' }}></div>
          ...
          <div style={{ marginTop: '12px', fontSize: '0.7rem', color: 'var(--text-muted, #64748b)', fontWeight: '700' }}>
            * Generated by Geo-Assist AI based on localized hydro-climatic data.
          </div>
        </div>
